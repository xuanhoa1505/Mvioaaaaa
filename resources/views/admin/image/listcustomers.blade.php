                  ...
                  <tr>
                     ...
                     <td>
                        <?php
                          if($data->stt==0){
                        ?>
                        <a href="{{URL::to('/unactive-designer/'.$data->id)}}"><span class="fa-thum-styling fa fa-thumbs-up"> </span><br>Hiển thị</a>
                         <?php }else{ ?>
                          <a href="{{URL::to('/active-designer/'.$data->id)}}"><span class="fa-thum-styling fa fa-thumbs-down"></span><br>Không hiển thị</a>
                          <?php  }
                          ?>
                     </td>
